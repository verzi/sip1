...
class GrinController extends ApiController {
    ...
    /**
     * @api {get} /monopatines/api/v1.0/grin Grin
     * @apiVersion 1.0.0
     * @apiName IndexGrin
     * @apiGroup Monopatines
     *
     * @apiDescription Retorna los monopatines de la empresa Grin.<br/> 
     *
     ...
     *  GET /monopatines/api/v1.0/grin HTTP/1.1
     *  Host: sip1.verzi.com.ar
     *  Cache-Control: no-cache
     *
     * @apiSuccessExample {json} Success-Response:
     * GET 'http://sip1.verzi.com.ar/monopatines/api/v1.0/grin?offset=0&limit=1'
     * HTTP/1.1 200 Ok
     * 
     *   {
     *       "metadata":{
     ...
     *   }
     *
     * @apiSampleRequest http://sip1.verzi.com.ar/monopatines/api/v1.0/grin
    ...
    public function index() {
        ...
        if ((!$this->cacheEnabled ) || ($data = Cache::read($cacheName)) === false) {
            $response = $this->http->get('/grin', $this->queryStringParams);
